/*
 * Thank you to artemisart for this script.  Find him at http://www.unity3d-france.com/unity/phpBB3/memberlist.php?mode=viewprofile&u=1254&sid=4a58896fe13bd14a79c3cab6012ce96e 
 * And his script here: http://www.unity3d-france.com/unity/phpBB3/viewtopic.php?f=24&t=5409
 */
...
public class GLDebug : MonoBehaviour {
    ...
    void SetMaterial() {
        GLDebug.matZOn = new Material(Shader.Find("BillyTheBot/GLlineZOn"));
        //GLDebug.matZOn.hideFlags = HideFlags.HideAndDontSave;
        //GLDebug.matZOn.shader.hideFlags = HideFlags.HideAndDontSave;

        GLDebug.matZOff = new Material(Shader.Find("BillyTheBot/GLlineZOff"));
        //GLDebug.matZOff.hideFlags = HideFlags.HideAndDontSave;
        //GLDebug.matZOff.shader.hideFlags = HideFlags.HideAndDontSave;
    }
